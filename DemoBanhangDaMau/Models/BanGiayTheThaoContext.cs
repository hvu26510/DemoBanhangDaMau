...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaCthd).HasName("PK__ChiTietH__1E4FA7715202B71C");
        ...
        {
            entity.HasKey(e => e.MaChiTiet).HasName("PK__ChiTietS__CDF0A114D965C866");
        ...
        {
            entity.HasKey(e => e.MaHoaDon).HasName("PK__HoaDon__835ED13B1F0C4346");
        ...
        {
            entity.HasKey(e => e.MaKhachHang).HasName("PK__KhachHan__88D2F0E5F5BA10DD");
        ...
        {
            entity.HasKey(e => e.MaKichCo).HasName("PK__KichCo__DE76ED876301F0A7");
        ...
        {
            entity.HasKey(e => e.MaMau).HasName("PK__MauSac__3A5BBB7DB53CBFA8");
        ...
        {
            entity.HasKey(e => e.MaNhanVien).HasName("PK__NhanVien__77B2CA47804177DE");
        ...
        {
            entity.HasKey(e => e.MaSanPham).HasName("PK__SanPham__FAC7442DEB145B87");
